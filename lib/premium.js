...
const addPremiumUser = (userId, expired) => {
    let _dir = JSON.parse(fs.readFileSync('./lib/database/premium.json'));
...
`
            		const contentText = {
            			...
            			contextInfo: {
        					...
        					title: `VIP EXPIRED 💳`,
        					previewType: "PHOTO",
        					thumbnailUrl: `https://raw.githubusercontent.com/NdikzDatabase/Database/main/Database/1756293718046-2v1e1b.jpg`,
        					sourceUrl: "-"
            				}
            			}
            		};
